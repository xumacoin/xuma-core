Contributing to XUMA Core
============================

The XUMA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XUMA Core project, and is not to be
confused with overall XUMA Network Protocol consensus changes.

Whether a pull request is merged into XUMA Core rests with the project merge
...
Patches that change XUMA consensus rules are considerably more involved than
...
Where a patch set proposes to change the XUMA consensus, it must have been
...
The project leader is the release manager for each XUMA Core release.
