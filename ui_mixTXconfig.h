/********************************************************************************
** Form generated from reading UI file 'mixTXconfig.ui'
**
...
#ifndef UI_MIXTXCONFIG_H
#define UI_MIXTXCONFIG_H
...
public:
    ...
    void retranslateUi(QDialog *DarksendConfig)
    {
        ...
        label_2->setText(QApplication::translate("DarksendConfig", "Use 2 separate masternodes to mix funds up to 10000 XMX", 0));
        label_3->setText(QApplication::translate("DarksendConfig", "Use 8 separate masternodes to mix funds up to 10000 XMX", 0));
        label_4->setText(QApplication::translate("DarksendConfig", "Use 16 separate masternodes", 0));
        label_6->setText(QApplication::translate("DarksendConfig", "This option is the quickest and will cost about ~0.025 XMX to anonymize 10000 XMX", 0));
        label_7->setText(QApplication::translate("DarksendConfig", "This option is moderately fast and will cost about 0.05 XMX to anonymize 10000 XMX", 0));
        ...
        label_9->setText(QApplication::translate("DarksendConfig", "0.1 Xuma per 10000 XMX you anonymize.", 0));
    } // retranslateUi
