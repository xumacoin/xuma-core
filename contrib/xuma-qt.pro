...
RESOURCES += src/qt/xuma.qrc src/qt/xuma_locale.qrc

TRANSLATIONS += src/qt/locale/xuma_bg.ts \
                src/qt/locale/xuma_de.ts \
                src/qt/locale/xuma_en.ts \
                src/qt/locale/xuma_es.ts \
                src/qt/locale/xuma_fi.ts \
                src/qt/locale/xuma_fr.ts \
                src/qt/locale/xuma_it.ts \
                src/qt/locale/xuma_ja.ts \
                src/qt/locale/xuma_pl.ts \
                src/qt/locale/xuma_pt.ts \
                src/qt/locale/xuma_ru.ts \
                src/qt/locale/xuma_sk.ts \
                src/qt/locale/xuma_sv.ts \
                src/qt/locale/xuma_vi.ts \
                src/qt/locale/xuma_zh_CN.ts \
                src/qt/locale/xuma_zh_TW.ts