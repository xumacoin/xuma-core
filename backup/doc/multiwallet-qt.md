...
In order to support loading of multiple wallets in xuma-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xuma.cpp.
...
Changes to xuma.cpp
----------------------
xuma.cpp is the entry point into xuma-qt, and as such, will require some minor modifications to provide hooks for
