...
Once these are installed, they will be found by configure and a xuma-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the xuma directory
BDB_PREFIX="${XUMA_ROOT}/db4"
mkdir -p $BDB_PREFIX
