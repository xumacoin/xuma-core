...
#   c) node1 mines 32 blocks, so now node 0 has 60001XMX, node 1 has 4250XMX, node2 has none.
#   d) node0 sends 601 XMX to node2, in two transactions (301 XMX, then 300 XMX).
