...
```
mn01 127.0.0.1:19777 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0
mn02 127.0.0.2:19777 93WaAb3htPJEV8E9aQcN23Jt97bPex7YvWfgMDTUdWJvzmrMqey aa9f1034d973377a5e733272c3d0eced1de22555ad45d6b24abadff8087948d4 0 7gnwGHt17heGpG9Crfeh4KGpYNFugPhJdh:25
```

## What about the xuma.conf file?

If you are using a masternode.conf file you no longer need the xuma.conf file. The exception is if you need custom settings (thanks oblox). 

## Update xuma.conf on server

If you generated a new masternode private key, you will need to update the remote xuma.conf files.
