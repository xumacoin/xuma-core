...
{
    //Xuma will hash in the transaction hash and the index number in order to make sure each hash is unique
...
{
	// XUMA TODO: renable once stacking generates a checkpoint
    /*
