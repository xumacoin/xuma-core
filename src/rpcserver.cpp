...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"xuma", "masternodelist", &masternodelist, true, true, false},
        {"xuma", "mnbudget", &mnbudget, true, true, false},
        {"xuma", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xuma", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xuma", "mnsync", &mnsync, true, true, false},
        {"xuma", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xuma", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xumad, or the -server option to xuma-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
