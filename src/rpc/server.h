...
extern UniValue setzXMXseed(const UniValue& params, bool fHelp);
extern UniValue getzXMXseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzXMX(const UniValue& params, bool fHelp);
extern UniValue dzXMXstate(const UniValue& params, bool fHelp);
