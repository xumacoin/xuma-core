...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XUMA features */
        {"xuma", "masternode", &masternode, true, true, false},
        {"xuma", "listmasternodes", &listmasternodes, true, true, false},
        {"xuma", "getmasternodecount", &getmasternodecount, true, true, false},
        {"xuma", "masternodeconnect", &masternodeconnect, true, true, false},
        {"xuma", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"xuma", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"xuma", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"xuma", "masternodecurrent", &masternodecurrent, true, true, false},
        {"xuma", "masternodedebug", &masternodedebug, true, true, false},
        {"xuma", "startmasternode", &startmasternode, true, true, false},
        {"xuma", "createmasternodekey", &createmasternodekey, true, true, false},
        {"xuma", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"xuma", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"xuma", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"xuma", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"xuma", "getmasternodescores", &getmasternodescores, true, true, false},
        {"xuma", "mnbudget", &mnbudget, true, true, false},
        {"xuma", "preparebudget", &preparebudget, true, true, false},
        {"xuma", "submitbudget", &submitbudget, true, true, false},
        {"xuma", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"xuma", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"xuma", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"xuma", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"xuma", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"xuma", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"xuma", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xuma", "checkbudgets", &checkbudgets, true, true, false},
        {"xuma", "mnsync", &mnsync, true, true, false},
        {"xuma", "spork", &spork, true, true, false},
        {"xuma", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzXMXseed", &getzXMXseed, false, false, true},
        {"zerocoin", "setzXMXseed", &setzXMXseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzXMX", &searchdzXMX, false, false, true},
        {"zerocoin", "dzXMXstate", &dzXMXstate, false, false, true}
...
{
    return "> xuma-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19643/\n";
}
