...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XUMA Core xuma-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xuma-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xuma transaction") + "\n" +
                               "  xuma-tx [options] -create [commands]   " + _("Create hex-encoded xuma transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xuma transaction
