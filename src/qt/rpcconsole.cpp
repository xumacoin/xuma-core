                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXMXPathCustom = GetArg("-zXMXbackuppath", "");
    ...
    if(!strzXMXPathCustom.empty()) {
        ui->wallet_customzXMXbackuppath->setText(QString::fromStdString(strzXMXPathCustom));
        ui->wallet_customzXMXbackuppath_label->setVisible(true);
        ui->wallet_customzXMXbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXMXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the XUMA RPC console.") + "<br>" +
