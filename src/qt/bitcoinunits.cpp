...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(XMX);
    unitlist.append(mXMX);
    unitlist.append(uXMX);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XMX:
            return QString("tXMX");
        case mXMX:
            return QString("mtXMX");
        case uXMX:
            return QString::fromUtf8("μtXMX");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case XMX:
            return QString("XMX");
        case mXMX:
            return QString("Milli-XMX (1 / 1" THIN_SP_UTF8 "000)");
        case uXMX:
            return QString("Micro-XMX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case XMX:
            return QString("TestXMXs");
        case mXMX:
            return QString("Milli-TestXMX (1 / 1" THIN_SP_UTF8 "000)");
        case uXMX:
            return QString("Micro-TestXMX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
