...
public:
    ...
    //CBigNum(char n) is not portable.  Use 'signed char' or 'unsigned char'.CBigNum(signed char n)        { bn = BN_new(); if (n >= 0) setulong(n); else setint64(n); }
